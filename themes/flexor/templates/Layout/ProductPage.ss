	...
	<div class="item-carousel" data-toggle="owlcarousel" data-owlcarousel-settings='{"items":4, "pagination":false, "navigation":true, "itemsScaleUp":true}'>
	  <div class="item">
		<a href="#" class="overlay-wrapper">
		  <img src="$ThemeDir/img/showcase/project1.png" alt="Project 1 image" class="img-responsive underlay">
		  <span class="overlay">
	  ...
	  <div class="item">
		<a href="#" class="overlay-wrapper">
		  <img src="$ThemeDir/img/showcase/project2.png" alt="Project 2 image" class="img-responsive underlay">
		  <span class="overlay">
	  ...
	  <div class="item">
		<a href="#" class="overlay-wrapper">
		  <img src="$ThemeDir/img/showcase/project3.png" alt="Project 3 image" class="img-responsive underlay">
		  <span class="overlay">
	  ...
	  <div class="item">
		<a href="#" class="overlay-wrapper">
		  <img src="$ThemeDir/img/showcase/project4.png" alt="Project 4 image" class="img-responsive underlay">
		  <span class="overlay">
	  ...
	  <div class="item">
		<a href="#" class="overlay-wrapper">
		  <img src="$ThemeDir/img/showcase/project5.png" alt="Project 5 image" class="img-responsive underlay">
		  <span class="overlay">
	  ...
	  <div class="item">
		<a href="#" class="overlay-wrapper">
		  <img src="$ThemeDir/img/showcase/project6.png" alt="Project 6 image" class="img-responsive underlay">
		  <span class="overlay">
	  ...
	  <div class="item">
		<a href="#" class="overlay-wrapper">
		  <img src="$ThemeDir/img/showcase/project7.png" alt="Project 7 image" class="img-responsive underlay">
		  <span class="overlay">
	  ...
	  <div class="item">
		<a href="#" class="overlay-wrapper">
		  <img src="$ThemeDir/img/showcase/project8.png" alt="Project 8 image" class="img-responsive underlay">
		  <span class="overlay">
	  ...
	  <div class="item">
		<a href="#" class="overlay-wrapper">
		  <img src="$ThemeDir/img/showcase/project9.png" alt="Project 9 image" class="img-responsive underlay">
		  <span class="overlay">
	  ...
	  <div class="item">
		<a href="#" class="overlay-wrapper">
		  <img src="$ThemeDir/img/showcase/project10.png" alt="Project 10 image" class="img-responsive underlay">
		  <span class="overlay">
	  ...
	  <div class="item">
		<a href="#" class="overlay-wrapper">
		  <img src="$ThemeDir/img/showcase/project11.png" alt="Project 11 image" class="img-responsive underlay">
		  <span class="overlay">
	  ...
	  <div class="item">
		<a href="#" class="overlay-wrapper">
		  <img src="$ThemeDir/img/showcase/project12.png" alt="Project 12 image" class="img-responsive underlay">
		  <span class="overlay">
  ...
  <div class="row">
	...
	<div class="col-md-6 m-b-lg">
	  ...
	  <blockquote>
		...
		<img src="$ThemeDir/img/misc/charles-quote.png" alt="Charles Spencer Chaplin">
		<small>
